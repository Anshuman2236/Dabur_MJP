...
const HomeTest = () => {
  ...
  const [InOutTableOpen,setInOutTableOpen] = useState("")
  ...
  const handleLinkClick = () => {
    setInOutTableOpen(true)
  };
  const closeTableModalCallback = ()=>{
    setInOutTableOpen(false)
  }
                ...
                <div className="main-container">
                  ...
                  <div className="left-grid">
                    ...
                    <div className="radio-buttons-container">
                      <RowRadioButtonsGroup updateState={updatedRadioState} />
                    </div>
                    ...
                    <div className="remark-container">
                      ...
                      >
                        <InModal isOpen={inModalOpen} closeDialog={closeModal} />
                        <InOutTable isOpen={InOutTableOpen} closeCallback={closeTableModalCallback}/>
                        <Button
